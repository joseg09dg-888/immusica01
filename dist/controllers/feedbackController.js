...
exports.getAllFeedback = exports.updateFeedbackStatus = exports.getFeedbackById = exports.getMyFeedback = exports.createFeedback = void 0;
...
const createFeedback = async (req, res) => {
    try {
      ...
      VALUES (?, ?, ?, ?, 'pending')
    `);
        const result = insert.run(req.user.id, type, title, description);
        res.status(201).json({
...
const getMyFeedback = async (req, res) => {
    try {
        if (!req.user)
            return res.status(401).json({ error: 'No autorizado' });
        const feedbacks = database_1.default.prepare(`
...
const getFeedbackById = async (req, res) => {
    try {
        ...
        const feedback = database_1.default.prepare(`
