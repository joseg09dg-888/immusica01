...
export default function Particles({
  ...
  particleSpread = 10,
  speed = 0.1,
  particleColors = ['#5E17EB', '#9B59B6', '#ffffff'],
  ...
  useEffect(() => {
    ...
    (gl.canvas as HTMLCanvasElement).style.cssText = 'position:absolute;inset:0;width:100%;height:100%;';
    ...
    let id: number, lastTime = performance.now(), elapsed = 0;
